...
const AdminCourseCard = ({ data }: Props) => {
  return (
      ...
      <CardContent className="p-4">
        ...
        <div className="mt-4 flex items-center gap-x-5">
          <div className="flex items-center gap-x-2">
            <TimerIcon className="size-6 p-1 rouned-md text-primary bg-primary/10" />
            <p className="text-sm text-muted-foreground">{data.duration}h</p>
          </div>
          <div className="flex items-center gap-x-2">
            <School className="size-6 p-1 rouned-md text-primary bg-primary/10" />
